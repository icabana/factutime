      ...
      <div class="card-body">
            ...
            <div class="tab-content">
              ...
              <div style="padding: 20px;" class="tab-pane active" id="tab_1">
                ...
                <?php
                  include("vistas/actores/clientes/editar_tab1.php");
                ?>
              ...
              <div style="padding: 20px;" class="tab-pane" id="tab_2">
                ...
                <?php
                  include("vistas/actores/clientes/editar_tab2.php");
                ?>
              ...
              <div style="padding: 20px;" class="tab-pane" id="tab_3">
                ...
                <?php
                  include("vistas/actores/clientes/editar_tab3.php");
                ?>
              ...
              <div style="padding: 20px;" class="tab-pane" id="tab_4">
                ...
                <?php
                    include("vistas/actores/clientes/editar_tab4.php");
                ?>
