<script type="text/javascript" >
    ...
    function editar_termino(){
        ...
        ejecutarAccion(
            'configuracion', 'Terminos', 'editarTermino', 
            datos, 'if(data == 1){ mensaje_alertas("success", "Terminos editado Exitosamente", "center"); cargarTerminos(); }else{  mensaje_alertas("error", "Error al editar el termino", "center");  }'
        );	
