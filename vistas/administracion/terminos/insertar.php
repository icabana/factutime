<script type="text/javascript" >
    ...
    function insertar_termino(){
        ...
        ejecutarAccion(
            'configuracion', 'Terminos', 'insertarTermino', 
            datos, 'if(data == 1){ mensaje_alertas("success", "Termino Registrada Exitosamente", "center"); cargarTerminos(); }else{  mensaje_alertas("error", "Error al insertar el Termino", "center");  }'
        );	
