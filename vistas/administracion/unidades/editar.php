<script type="text/javascript" >
    ...
    function editar_unidad(){
        ...
        ejecutarAccion(
            'configuracion', 'Unidades', 'editarUnidad', 
            datos, 'if(data == 1){ mensaje_alertas("success", "Unidades editado Exitosamente", "center"); cargarUnidades(); }else{  mensaje_alertas("error", "Error al editar el unidad", "center");  }'
        );	
