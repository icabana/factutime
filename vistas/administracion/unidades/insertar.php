<script type="text/javascript" >
    ...
    function insertar_unidad(){
        ...
        ejecutarAccion(
            'configuracion', 'Unidades', 'insertarUnidad', 
            datos, 'if(data == 1){ mensaje_alertas("success", "Unidad Registrada Exitosamente", "center"); cargarUnidades(); }else{  mensaje_alertas("error", "Error al insertar el Unidad", "center");  }'
        );	
