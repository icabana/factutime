<script type="text/javascript" >
    ...
    function abrir_editar_recibos(id_recibo){

        abrirVentanaContenedor(
            'recibos', 
            'Recibos', 
            'abrirEditarRecibo',
            'id_recibo='+id_recibo+'&tipo='+$("#tipo_recibo").val(),
    ...
    function eliminar_recibo2(id_recibo){
        ...
        ejecutarAccion(
            ...
            'eliminarRecibo', 
            "id_recibo="+id_recibo, 
            'mensaje_alertas("success", "Recibo Eliminado Correctamente", "center"); cargarRecibos();' 
        );
    ...
    <div class="col-xs-12">
        ...
        <div style="padding:25px" class="box">
            ...
            <div class="box-header">
                ...
                <h3 class="box-title">
                    ...
                    <table>
                           <tr>
                            <td>
                                    <h1 style='font-size:20px'>GESTIONAR RECIBOS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h1>
                            </td>
                            <td>
                                <p></p>
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <table id="tabla_recibos" style="width:100%;" cellpadding="0" cellspacing="0" border="0" class="display" >
...
<?php
            ...
            if($_SESSION['rol'] == 8){
                  ...
                  echo '<td style="width:25px" onclick="abrir_editar_recibos(' . $items["ID_RECIBO"] .');"><a href="#">Editar</a></td>';  
