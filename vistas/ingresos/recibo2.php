<?php
   ...
   $this->pdf->SetFont('Arial','B',6);          
      $this->pdf->Cell(25, 4, utf8_decode('FECHA DE PAGO: '),1,0,''); 
       $this->pdf->SetFont('Arial','',6);    
      $this->pdf->Cell(0, 4,  $recibo['FECHA_RECIBO'],1,1);  
      ...
      $this->pdf->Cell(0, 5, utf8_decode('Resolucion de facturacion #11000051835 de la factura 1001 hasta 2000 en computador. Fecha de Expedición 2014-01-02'),0,0, "C");  
